      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="caption-img text-right">
            <img src="/front_asset/images/watch-7.png" class="img-fluid animation-jump" alt>
          </div>
        </div>
        <!--end caption image-->
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="about-img text-center">
            <img src="/front_asset/images/watch-8.png" class="img-fluid animation-jump" alt="Image">
          </div>
        </div>
        <!--end about image-->
        <!--start about info-->
      ...
      <div class="row">
        ...
        <div class="col-lg-5 col-md-6">
          <div class="product-gallery owl-carousel">
            <img src="/front_asset/images/watch-14.png" class="img-fluid" alt>
            <img src="/front_asset/images/watch-15.png" class="img-fluid" alt>
            <img src="/front_asset/images/watch-12.png" class="img-fluid" alt>
          </div>
        </div>
        <!--end product gallery-->
          ...
          <div class="col-md-6">
            <div class="product-single row">
              <div class="product-img text-center col-lg-6">
                <img src="/front_asset/images/watch-3.png" class="img-fluid" alt="Image">
              </div>
              ...
              <div class="product-cont col-lg-6">
                ...
                <h3>${{ $pr->sales_price }} <del><sup>${{ $pr->price }}</sup></del></h3>
                {{-- Button AddToBasket --}}
                <addtobasket product_id={{ $pr->id }}></addtobasket>
              </div>
          ...
          <div class="col-md-6">
            ...
            <div class="card">
              <div class="card-header" role="tab" id="faq1">
                <h5 class="mb-0">
                  <a data-toggle="collapse" href="#collapse1" aria-expanded="false" aria-controls="collapse1">How
                    can I buy the watch?</a>
                </h5>
              </div>
              <div id="collapse1" class="collapse" role="tabpanel" aria-labelledby="faq1" data-parent="#accordion2">
                <div class="card-body">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Phasellus hendrerit.
                  ...
                  nibh. Nullam mollis. Ut justo. Suspendisse potenti.</div>
              </div>
            </div>
            <!--end faq single-->
            <!--start faq single-->
    ...
    <div class="container">
      ...
      <div class="testi-carousel owl-carousel">
        ...
        <div class="testi-single text-center">
          <div class="client-info">
            <div class="client-img">
              <img src="/front_asset/images/client-1.jpg" class="img-fluid" alt>
            </div>
          ...
          <div class="client-comment">
            ...
            <p class="mb-2"><i class="icofont-star"></i><i class="icofont-star"></i><i class="icofont-star"></i><i
        ...
        <div class="testi-single text-center">
          <div class="client-info">
            <div class="client-img">
              <img src="/front_asset/images/client-2.jpg" class="img-fluid" alt>
            </div>
            <div class="client-details">
              <h4>Andrew Watt</h4>
        ...
        <div class="testi-single text-center">
          <div class="client-info">
            <div class="client-img">
              <img src="/front_asset/images/client-3.jpg" class="img-fluid" alt>
            </div>
            <div class="client-details">
              <h4>Emma Dee</h4>
              <p>App Developer</p>
        ...
        <div class="testi-single text-center">
          <div class="client-info">
            <div class="client-img">
              <img src="/front_asset/images/client-4.jpg" class="img-fluid" alt>
            </div>
            <div class="client-details">
              <h4>Olivia Smith</h4>
              <p>Web Developer</p>
      ...
      <div class="row">
        ...
        <div class="col-md-5">
          <div class="contact-img text-center">
            <img src="/front_asset/images/watch-10.png" class="img-fluid animation-jump" alt>
          </div>
        </div>
        <!--end contact image-->
      </div>
